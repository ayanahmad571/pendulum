...
$sitebasics = getdatafromsql($conn, "select * from tpt_basics");
$title = $sitebasics['bsc_title'];
$subheading = $sitebasics['bsc_subheading'];
$serverlink = $sitebasics['bsc_serverlink'];

$icons = '						<ul class="icons">
                            <li><a href="'.$sitebasics['bsc_twitter'].'" class="icon alt fa-twitter"><span class="label">Twitter</span></a></li>
                            <li><a href="'.$sitebasics['bsc_facebook'].'" class="icon alt fa-facebook"><span class="label">Facebook</span></a></li>
                            <li><a href="'.$sitebasics['bsc_instagram'].'" class="icon alt fa-instagram"><span class="label">Instagram</span></a></li>
						</ul>
';
?>
